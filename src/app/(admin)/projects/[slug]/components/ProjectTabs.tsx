  ...
  const handleAdvanceStatus = async () => {
    if (currentIndex < statuses.length - 1) {
      ...
      await updateProjectStatus(
        project.slug,
        statuses[currentIndex + 1] as any,
      );
      setLoading(false);
    }
  };
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm animate-in fade-in duration-300">
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <p
                      className={`text-sm ${currentIndex >= 1 ? "text-slate-500 line-through" : currentIndex === 0 ? "font-semibold text-slate-900" : "text-slate-400"}`}
                    >
                      Awaiting Signature
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p
                      className={`text-sm ${currentIndex >= 2 ? "text-slate-500 line-through" : currentIndex === 1 ? "font-semibold text-slate-900" : "text-slate-400"}`}
                    >
                      Collecting Assets
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p
                      className={`text-sm ${currentIndex >= 3 ? "text-slate-500 line-through" : currentIndex === 2 ? "font-semibold text-slate-900" : "text-slate-400"}`}
                    >
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p
                      className={`text-sm ${currentIndex >= 4 ? "text-slate-500 line-through" : currentIndex === 3 ? "font-semibold text-slate-900" : "text-slate-400"}`}
                    >
                      In Review
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p
                      className={`text-sm ${currentIndex >= 5 ? "text-slate-500 line-through" : currentIndex === 4 ? "font-semibold text-slate-900" : "text-slate-400"}`}
                    >
                      Final Delivery
                    </p>
                  </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <p
                      className={`text-sm ${currentIndex === 5 ? "font-semibold text-slate-900" : "text-slate-400"}`}
                    >
                      Completed
                    </p>
                  </div>
                      ...
                      <div className="flex flex-wrap gap-4 mt-3">
                        {item.previewUrl && (
                          <div className="flex w-10 justify-between">
                            ...
                            >
                              <Download className="w-3 h-3 mr-1" /> View Preview
                              File
                            </a>
                        ...
                        {item.fileUrl && (
                          ...
                          >
                            <Download className="w-3 h-3 mr-1" /> View Final
                            File
                          </a>
                        )}
                      </div>
                        ...
                        <div className="flex gap-2">
                          <div className="border border-slate-200 rounded-lg bg-white px-2 py-1 shadow-sm">
                            <UploadButton
                              ...
                              appearance={{
                                button:
                                  "text-[10px] font-bold text-slate-600 bg-transparent border-none py-0.5 px-2 h-auto w-auto after:hidden",
                          ...
                          <div className="border border-indigo-200 rounded-lg bg-indigo-50 px-2 py-1 shadow-sm">
                            <UploadButton
                              ...
                              appearance={{
                                button:
                                  "text-[10px] font-bold text-indigo-700 bg-transparent border-none py-0.5 px-2 h-auto w-auto after:hidden",
                                allowedContent: "hidden",
                              }}
