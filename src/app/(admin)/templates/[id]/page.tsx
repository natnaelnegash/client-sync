...
export default async function TemplateDetailPage({
  ...
  if (!template || template.userId !== ownerId) {
    return notFound();
  }
  ...
  if (milestoneIds.length > 0) {
    ...
    deliverables = deliverables.filter(d => milestoneIds.includes(d.milestoneId));
  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
      <div className="mb-6">
        <Link href="/templates" className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-slate-900 transition-colors">
